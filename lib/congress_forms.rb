...
Capybara.register_driver :headless_chrome do |app|
  ...
  browser_options = ::Selenium::WebDriver::Chrome::Options.new.tap do |opts|
    opts.args.merge(%w(--new-window --no-sandbox --disable-dev-shm-usage  --window-size=1200,1400  --proxy-server=http://dc5106a9eee74ef8896bbe4599e4c332:@proxy.crawlera.com:8010))
